            ...
            <div className="modal-main modal--change">
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="form-group">
                        ...
                        <label>Name: </label>
                        <br/>
                        <input className="form-control-lg" onChange={this.handleChange} placeholder="Full name" name="name" type="text"/>
                        <br/>
                        <label>Email: </label>
                        <br/>
                        ...
                        <br/>
                        <textarea onChange={this.handleChange} row="4" cols="50" placeholder="What would you like to ask?" name="description" type="text"/>
                        <br/>
